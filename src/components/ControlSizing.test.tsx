...
describe('shared control sizing', () => {
  it('keeps default, small, cancel, and theme controls at least 44 CSS px high', () => {
    render(<><Button>Default</Button><Button size="sm">Small</Button><Button variant="outline">Cancel</Button><ThemeToggle /></>);
